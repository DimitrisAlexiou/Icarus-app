...
export const defineDegreeRules = tryCatch(async (req: Request, res: Response) => {
...
export const viewDegreeRules = tryCatch(async (_: Request, res: Response) => {
...
export const updateDegreeRules = tryCatch(async (req: Request, res: Response) => {
...
export const deleteAllDegreeRules = tryCatch(async (_: Request, res: Response) => {
