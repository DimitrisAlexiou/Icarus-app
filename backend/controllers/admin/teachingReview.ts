...
export const getAllTeachingReviews = tryCatch(async (_: Request, res: Response) => {
...
export const deleteAllTeachingReviews = tryCatch(async (_: Request, res: Response) => {
	await deleteTeachingReviews();
	return res.status(200).json({ message: 'Teaching reviews existing in the system deleted.' });
});
