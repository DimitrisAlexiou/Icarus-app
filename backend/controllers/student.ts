...
export const createCourseStatement = tryCatch(async (req: Request, res: Response) => {
	// if (
	// ) {
	...
	if (existingCourseStatement)
		throw new CustomError('Seems like a course statement for this user has been made.', 400);
