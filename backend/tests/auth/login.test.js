...
describe('loginController', () => {
	...
	// write the test case for the login controller
	// for 'should return 400 and error message if username or password is not provided' test case
	...
	// for 'should return 200 and user and token if user is found and password is correct' test case
	// you can use the following code
	// const user = {
	//     _id: '123456789',
	//     username: 'icsd17009',
