...
export const GET_TEACHING_BY_COURSE_ID = createAction('teaching/get_teaching_by_courseId');
...
export const ASSIGN_THEORY_INSTRUCTORS = createAction('teaching/assign_theory_instructors');
...
export const DEFINE_ASSESSMENT = createAction('admin/configuration/define_assessment');
export const GET_ASSESSMENT = createAction('admin/configuration/get_assessment');
export const UPDATE_ASSESSMENT = createAction('admin/configuration/update_assessment');
export const DELETE_ASSESSMENT = createAction('admin/configuration/delete_assessment');
...
export const DEFINE_DEGREE_RULES = createAction('admin/configuration/define_degree_rules');
export const GET_DEGREE_RULES = createAction('admin/configuration/get_degree_rules');
export const UPDATE_DEGREE_RULES = createAction('admin/configuration/update_degree_rules');
export const DELETE_DEGREE_RULES = createAction('admin/configuration/delete_degree_rules');
...
export const DEFINE_SEMESTER = createAction('admin/configuration/define_semester');
export const UPDATE_SEMESTER = createAction('admin/configuration/update_semester');
export const GET_SEMESTER = createAction('admin/configuration/get_semester');
export const DELETE_SEMESTER = createAction('admin/configuration/delete_semester');
