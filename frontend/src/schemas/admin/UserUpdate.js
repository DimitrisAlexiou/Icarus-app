...
import { nameRegex, studentIdRegex, surnameRegex, usernameRegex } from '../../constants/regex';
...
export const UserUpdateSchema = Yup.object().shape({
	...
	loginFailedAttempts: Yup.number().oneOf(
		[0, 1, 2, 3],
		'Invalid login failed attempts flag. Only 0, 1, 2, or 3 are allowed.'
	),
