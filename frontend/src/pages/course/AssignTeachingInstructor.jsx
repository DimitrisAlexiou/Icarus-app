...
import AssignInstructorForm from '../../components/course/AssignInstructorForm';
...
export default function AssignTeachingInstructor() {
	...
	if (isSemesterLoading || isTeachingsLoading || isInstructorsLoading) return <Spinner />;
												...
												<Col className="d-flex justify-content-end">
													<FontAwesomeIcon
														...
														onClick={(e) => {
															e.stopPropagation();
															dispatch(
																unassignLabInstructors(teaching._id)
															);
															setFormIsVisible(false);
														}}
													/>
